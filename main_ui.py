...
# Form implementation generated from reading ui file 'misc/layout.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.message_label = QtWidgets.QLabel(self.data_display_group)
        font = QtGui.QFont()
        font.setPointSize(22)
        font.setBold(True)
        ...
        self.gridLayout_2.addWidget(self.message_label, 0, 0, 1, 2)
        ...
        self.speed_slower_radio = QtWidgets.QRadioButton(self.stripchart_control_group)
        self.speed_slower_radio.setGeometry(QtCore.QRect(13, 39, 152, 20))
        font = QtGui.QFont()
        font.setFamily("IBM Plex Sans")
        self.speed_slower_radio.setFont(font)
        self.speed_slower_radio.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.speed_slower_radio.setObjectName("speed_slower_radio")
        self.chart_clear_button = QtWidgets.QPushButton(self.stripchart_control_group)
        self.chart_clear_button.setGeometry(QtCore.QRect(9, 127, 109, 32))
        font = QtGui.QFont()
        font.setFamily("IBM Plex Sans")
        ...
        self.speed_default_radio.setGeometry(QtCore.QRect(13, 66, 69, 20))
        font = QtGui.QFont()
        font.setFamily("IBM Plex Sans")
        self.speed_default_radio.setFont(font)
        self.speed_default_radio.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.speed_faster_radio.setGeometry(QtCore.QRect(13, 93, 152, 20))
        font = QtGui.QFont()
        font.setFamily("IBM Plex Sans")
        self.speed_faster_radio.setFont(font)
        self.speed_faster_radio.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.speed_faster_radio.setObjectName("speed_faster_radio")
        self.chart_legacy_button = QtWidgets.QPushButton(self.stripchart_control_group)
        self.chart_legacy_button.setGeometry(QtCore.QRect(9, 211, 124, 32))
        font = QtGui.QFont()
        font.setFamily("IBM Plex Sans")
        ...
        self.chart_refresh_button.setGeometry(QtCore.QRect(9, 169, 121, 32))
        font = QtGui.QFont()
        font.setFamily("IBM Plex Sans")
        self.chart_refresh_button.setFont(font)
        self.chart_refresh_button.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        MainWindow.setTabOrder(self.speed_faster_radio, self.chart_clear_button)
        MainWindow.setTabOrder(self.chart_clear_button, self.chart_refresh_button)
        MainWindow.setTabOrder(self.chart_refresh_button, self.chart_legacy_button)
        MainWindow.setTabOrder(self.chart_legacy_button, self.stripchart)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.speed_faster_radio.setText(_translate("MainWindow", "Faster (fewer points)"))
        self.chart_legacy_button.setText(_translate("MainWindow", "Legacy Mode"))
        self.chart_refresh_button.setText(_translate("MainWindow", "Refresh axes"))
