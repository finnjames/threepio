...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.message_group_box.sizePolicy().hasHeightForWidth())
        self.message_group_box.setSizePolicy(sizePolicy)
        ...
        MainWindow.setTabOrder(self.dec_view, self.variance_dial)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.toggle_channel_button.setText(_translate("MainWindow", "Toggle Channels"))
