...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout.addWidget(self.file_name_value, 8, 2, 1, 1)
        ...
        self.accept_button = QtWidgets.QPushButton(self.button_box)
        font = QtGui.QFont()
        font.setFamily("IBM Plex Sans")
        self.accept_button.setFont(font)
        self.accept_button.setObjectName("accept_button")
        self.gridLayout_2.addWidget(self.accept_button, 0, 2, 1, 1)
        self.cancel_button = QtWidgets.QPushButton(self.button_box)
        font = QtGui.QFont()
        font.setFamily("IBM Plex Sans")
        ...
        self.gridLayout.addWidget(self.button_box, 9, 1, 1, 2)
